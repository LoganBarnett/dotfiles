...
values."
  (setq-default
   ...
   dotspacemacs-excluded-packages '(
                                    ...
                                    ;; Other means must be used to prevent its
                                    ;; behavior. Arguably smartparens provides
                                    ;; other value anyways, by highlighting
                                    ;; unmatched pairs:
                                    ;; https://github.com/syl20bnr/spacemacs/issues/6144
                                    ;; smartparens
                                    )
...
values."
  ...
  (setq-default
   ...
   ;; Plex, and Fira. Ubuntu and Tahoma aren't bad standbys, but could be
   ;; better.
   ...
   ;;   :size-limit-kb 1000)
   ;; (default nil)
   dotspacemacs-line-numbers '(:relative t :visual t)
...
(custom-set-variables
 ...
 '(mml-secure-key-preferences
   (quote
    ((OpenPGP
      (sign
       ("logustus@gmail.com" "3F295F7D24276467A9B2345941E46FB1ACEA3EF0"))
      (encrypt
       ("logustus@gmail.com" "3F295F7D24276467A9B2345941E46FB1ACEA3EF0")))
     (CMS
      (sign)
