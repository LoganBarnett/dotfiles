...
const vars = {
  ...
  '--button-focus-background-color': '#205050',
  '--button-focus-color': '#5ad1de',
  '--button-hover-color':  '#6ae1ee',
  '--button-hover-border': '2px solid #6ae1ee',
  '--button-hover-background-color': '#306060',
  ...
  '--head5-color': '#4f97d7',
  '--head5-background-color': '#293239',
  '--head6-color': '#2d9574',
  '--head6-background-color': '#293235',
  ...
  '--table-header-active-color': '#e3dedd',
  '--table-header-active-background-color': '#3b314d',
  '--table-header-hover-color': '#79e',
  '--table-header-hover-background-color': '#235',
