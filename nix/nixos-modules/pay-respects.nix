...
# https://github.com/NixOS/nixpkgs/blob/nixos-25.05/nixos/modules/programs/pay-respects.nix
# which I am including here because I want to see it working in a macOS
# environment.  If this works fine, I'll submit a pull request to nix-darwin to
# have it added.  Perhaps there's some way we can upstream modules that have
# been blessed so we needn't track them independently?
################################################################################
{
  config,
  pkgs,
