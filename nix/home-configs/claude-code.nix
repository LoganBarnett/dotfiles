  ...
  programs.claude-code = {
    ...
    agents = {
      standards-reviewer = ''
        ...
        description: Reviews code changes for compliance with documented coding standards. Use proactively after code changes.
        model: sonnet
        color: blue
      ...
      senior-engineer = ''
        ...
        description: Reviews changes for engineering best practices, focusing on maintainability, verification, and operability. Use proactively after code changes or before deployment.
        model: sonnet
        color: green
        tools: [read, grep, glob]
        memory:
